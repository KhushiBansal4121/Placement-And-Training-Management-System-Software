...
Original file is located at
    https://colab.research.google.com/drive/1WyVy55Ry0bGjbYQptVmq4DxIEs0bRmn-
...
def login(choice) :
  if(choice is ( 1 or 2 or 3)):
    ...
    if(j == 1):
      ...
      email = input("Enter Your Developer / Software Handlers Email Id :- ")
      password = input("Enter Your Personal Password ( Don't Disclose It To Anyone .................)")
      
      #Create Table
      my_conn.execute('''
      CREATE TABLE IF NOT EXISTS login_developer_or_software_handler
      (
      email text Primary Key , 
      password text UNIQUE 
      );''')
      my_conn.commit()
      print("Login Account Developer Or Software Handler Created Successfully . ")

      #Insert Data
      my_conn.execute("insert into login_developer_or_software_handler values(?,?)",(email , password))

      print("\n............... Login Account User Complete Information Table For Developers And Handlers OF TPOMSSoftware ..................\n")
      #Represent Data User . 
      r_set=my_conn.execute('''SELECT * from login_user''');
      for row in r_set: # r_set can be anything rset , rsetu , r_set_u or rs etc , only need to follow variable declaration rules which is important / necessary / reuired or mandatory
        print(row)
      print("\n\n")

      print("\n............... Login Account Recruiter / Company Complete Information Table For Developers And Handlers OF TPOMSSoftware ..................\n")
      #Represent Data Company .
      r_set=my_conn.execute('''SELECT * from login_recruiter''');
      for row in r_set:
        print(row)
      print("\n\n") 

      print("\n...............Login Account Service Provider Complete Information Table For Developers And Handlers OF TPOMSSoftware ..................\n")
      #Represent Data Service Provider 
      r_set=my_conn.execute('''SELECT * from login_service_provider''');
      for row in r_set:
        print(row)
      print("\n\n")
...
def create_account(choice) :
  ...
  if(choice is not 3):
    ...
    if(choice  is not ( 2 or 3 )):
      print("\n...............Create Account User Complete Information Table For Developers And Handlers OF TPOMSSoftware ..................\n")
      #Represent Data User . 
      r_set=my_conn.execute('''SELECT * from account_user''');
      for row in r_set: # r_set can be anything rset , rsetu , r_set_u or rs etc , only need to follow variable declaration rules which is important / necessary / reuired or mandatory
        print(row)
      print("\n\n")
    if(choice is not( 1 or 3 )):
      print("\n...............Create Account Recruiter / Company Complete Information Table For Developers And Handlers OF TPOMSSoftware ..................\n")
      #Represent Data Company .
      r_set=my_conn.execute('''SELECT * from account_recruiter''');
      for row in r_set:
        print(row)
      print("\n\n") 
    if(choice is not( 1 or 2)) :
      print("\n...............Create Account Service Provider Complete Information Table For Developers And Handlers OF TPOMSSoftware ..................\n")
      #Represent Data Service Provider 
      r_set=my_conn.execute('''SELECT * from account_service_provider''');
      for row in r_set:
        print(row)
      print("\n\n")
